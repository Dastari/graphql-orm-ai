...
#[test]
fn crate_source_has_no_direct_database_or_consumer_dependency() {
    ...
    for consumer_name in ["digitse", "gema", "fame-service", "cosmo"] {
        assert!(!manifest.to_ascii_lowercase().contains(consumer_name));
    }
