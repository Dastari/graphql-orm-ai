            ...
            .transaction(TransactionMode::StateMachine, move |tx| {
                Box::pin(async move {
                    ...
                    tx.insert::<AiToolCallRecord>(CreateAiToolCallRecordInput {
                        ...
                        protected_arguments: call.protected_arguments,
            ...
            .transaction(TransactionMode::StateMachine, move |tx| {
                Box::pin(async move {
                    ...
                    tx.insert::<AiProposalRecord>(CreateAiProposalRecordInput {
                        ...
                        protected_payload: proposal.protected_payload,
            ...
            .transaction(TransactionMode::StateMachine, move |tx| {
                Box::pin(async move {
                    ...
                    tx.insert::<AiApprovalRecord>(CreateAiApprovalRecordInput {
                        ...
                        protected_resource_bindings: approval.protected_resource_bindings,
                        protected_action_preview: approval.protected_action_preview,
